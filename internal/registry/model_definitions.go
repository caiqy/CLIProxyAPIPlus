...
func GetGitHubCopilotModels() []*ModelInfo {
	...
	models := []*ModelInfo{
		...
		},
		{
			...
			Description:         "OpenAI GPT-4.1 2025-04-14 via GitHub Copilot",
			ContextLength:       128000,
			MaxCompletionTokens: 16384,
			SupportedEndpoints:  []string{"/chat/completions", "/responses"},
		},
		{
			...
			Description:         "OpenAI GPT-4.1 Copilot via GitHub Copilot",
			ContextLength:       128000,
			MaxCompletionTokens: 16384,
		},
		{
			...
			Description:         "OpenAI GPT-4o Mini via GitHub Copilot",
			ContextLength:       128000,
		...
		},
		{
			...
			Description:         "OpenAI GPT-4o Mini 2024-07-18 via GitHub Copilot",
			ContextLength:       128000,
			MaxCompletionTokens: 4096,
		},
		{
		...
		},
		{
			...
			Type:                "github-copilot",
			DisplayName:         "GPT 4",
			Description:         "OpenAI GPT 4 via GitHub Copilot",
			ContextLength:       32768,
			MaxCompletionTokens: 4096,
		},
		{
			...
			Description:         "OpenAI GPT 4 0613 via GitHub Copilot",
			ContextLength:       32768,
			MaxCompletionTokens: 4096,
		},
		{
			...
			Description:         "OpenAI GPT 3.5 Turbo via GitHub Copilot",
			ContextLength:       16384,
			MaxCompletionTokens: 4096,
		},
		{
			...
			Description:         "OpenAI GPT 3.5 Turbo 0613 via GitHub Copilot",
			ContextLength:       16384,
			MaxCompletionTokens: 4096,
		},
		{
			...
			Description: "OpenAI Embedding V3 Small via GitHub Copilot",
		},
		{
			...
			Description: "OpenAI Embedding V3 Small Inference via GitHub Copilot",
		},
		{
			...
			Description: "OpenAI Embedding Ada 002 via GitHub Copilot",
		},
	}
